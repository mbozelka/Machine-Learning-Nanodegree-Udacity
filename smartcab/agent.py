...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        # pick a default one to start
        maxQ = self.Q[state]['left']

        # loop and update if another action is better
    ...
    def learn(self, state, action, reward):
        ...
        # Derived equation with help from this question posted on forums: 
        # https://discussions.udacity.com/t/not-clear-about-what-value-iteration-update-rule-in-learn-method-in-agent-py-means/242021/5
        if self.learning:
